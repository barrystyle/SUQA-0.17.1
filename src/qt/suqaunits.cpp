...
QString BitcoinUnits::shortName(int unit)
{
    switch(unit)
    {
    case uSUQA: return QString::fromUtf8("bits");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case SUQA: return QString("Bitcoins");
    case mSUQA: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uSUQA: return QString("Micro-Bitcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
